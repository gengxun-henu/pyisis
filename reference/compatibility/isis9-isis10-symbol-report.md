...
- ISIS 9 source: `reference/upstream_isis/9.0.0`
- ISIS 10 source: `reference/upstream_isis/10.0.0`
- 当前 binding-header 引用行数（过滤 GUI 后）: 533
- 当前 ISIS 头文件数: 379
- 文本一致: 330
- 需要人工复核: 47
- 已识别头文件重命名候选: 1
...
| `src/bind_low_level_cube_io.cpp` | `Endian.h` | `renamed_review_required` | `IEndian.h:isis/src/core/include/IEndian.h` | `non_gui` |
