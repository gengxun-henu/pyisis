# Install PyISIS v1.4.0rc3 for ISIS 10 on Windows x64
...
python -m pip install --no-index --find-links wheelhouse usgs-pyisis-isis10==1.4.0rc3
```
...
The expected output starts with `1.4.0rc3 10.0.0`.
