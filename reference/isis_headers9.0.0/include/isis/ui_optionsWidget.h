...
public:
    ...
    {
        matrixOptionsWidget->setWindowTitle(QCoreApplication::translate("matrixOptionsWidget", "Matrix Options", nullptr));
        toleranceRadioButton->setText(QCoreApplication::translate("matrixOptionsWidget", "Pick Tolerance", nullptr));
        badCorrelationLabel->setText(QCoreApplication::translate("matrixOptionsWidget", "Bad Correlation", nullptr));
        toleranceLabel->setText(QCoreApplication::translate("matrixOptionsWidget", "Tolerance:", nullptr));
        goodCorrelationLabel->setText(QCoreApplication::translate("matrixOptionsWidget", "Good Correlation", nullptr));
        gradientRadioButton->setText(QCoreApplication::translate("matrixOptionsWidget", "Color Gradient", nullptr));
        matrixOptionsTabs->setTabText(matrixOptionsTabs->indexOf(colorOptionsPage), QCoreApplication::translate("matrixOptionsWidget", "Color Options", nullptr));
        bestCorrelationRadioButton->setText(QCoreApplication::translate("matrixOptionsWidget", "Best Correlation", nullptr));
        worstCorrelationRadioButton->setText(QCoreApplication::translate("matrixOptionsWidget", "Worst Correlation", nullptr));
        specificCorrelationRadioButton->setText(QCoreApplication::translate("matrixOptionsWidget", "Specific Parameters", nullptr));
        focusParametersLabel1->setText(QCoreApplication::translate("matrixOptionsWidget", "Image 1:", nullptr));
        focusParametersLabel2->setText(QCoreApplication::translate("matrixOptionsWidget", "Image 2:", nullptr));
        focusToleranceRadioButton->setText(QCoreApplication::translate("matrixOptionsWidget", "Tolerance", nullptr));
        focusToleranceLabel->setText(QCoreApplication::translate("matrixOptionsWidget", "Tolerance", nullptr));
        goodElementsLabel->setText(QCoreApplication::translate("matrixOptionsWidget", "Good Correlations", nullptr));
        badElementsLabel->setText(QCoreApplication::translate("matrixOptionsWidget", "Bad Correlations", nullptr));
        matrixOptionsTabs->setTabText(matrixOptionsTabs->indexOf(focusOptionsPage), QCoreApplication::translate("matrixOptionsWidget", "Focus Options", nullptr));
        correlationLabel->setText(QCoreApplication::translate("matrixOptionsWidget", "Current Correlation Value:", nullptr));
        currentValue->setText(QCoreApplication::translate("matrixOptionsWidget", "Current Value", nullptr));
        image1Name->setText(QCoreApplication::translate("matrixOptionsWidget", "Image 1 Name", nullptr));
        parameter1Name->setText(QCoreApplication::translate("matrixOptionsWidget", "Parameter 1 Name", nullptr));
        image2Name->setText(QCoreApplication::translate("matrixOptionsWidget", "Image 2 Name", nullptr));
        parameter2Name->setText(QCoreApplication::translate("matrixOptionsWidget", "Parameter 2 Name", nullptr));
    } // retranslateUi
