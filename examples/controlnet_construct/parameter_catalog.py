...
PARAMETERS = (
    ...
    _spec("deep_match_manifest_dir", "pipeline", config_path=_image_match_path("deep_match_manifest_dir"), entrypoints=(RUN_PIPELINE, IMAGE_MATCH), help="Directory containing deep-match manifests."),
    _spec("deep_match_manifest_summary", "pipeline", config_path=_image_match_path("deep_match_manifest_summary"), entrypoints=(RUN_PIPELINE, IMAGE_MATCH), help="Manifest summary JSON path."),
    ...
    _spec("enable_adaptive_routing", "adaptive_routing", config_path=_image_match_path("enable_adaptive_routing"), value_type="bool", default=False, entrypoints=_MATCH_ENTRYPOINTS, help="Enable adaptive matcher routing."),
    ...
    _spec("pair_id_start", "controlnet", config_path="ControlNet.pair_id_start", value_type="int", min_value=0, entrypoints=(RUN_PIPELINE, FROM_ORI_MATCH, FROM_DOM_BATCH), help="Starting generated pair identifier number."),
