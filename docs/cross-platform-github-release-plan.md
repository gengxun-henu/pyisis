...
| --- | --- | --- |
| Python package version | `1.3.0rc3` | `1.4.0rc3` |
| Supported USGS ISIS | `9.0.0` | `10.0.0` |
| Git tag | `v1.3.0rc3-isis9.0.0` | `v1.4.0rc3-isis10.0.0` |
| Release title | `PyISIS v1.3.0rc3 (USGS ISIS 9.0.0)` | `PyISIS v1.4.0rc3 (USGS ISIS 10.0.0)` |
...
`v1.4.0rc3-isis10.0.0` contains the corresponding cp313 Linux and Windows
...
```text
python -m pip install --no-index --find-links wheelhouse usgs-pyisis==1.3.0rc3
```
